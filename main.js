function C(n, k) {
    ...
    var p = 1, m = n;
    // if(k<1 || typeof(n)!=Number    ) return 0; else
    for (j = 1; j <= k; j++) {
        p = p * m / j;
        m--;
    }
...
brojkombinacije+=C(broj-i,6);
    ...
    for(k=i+1;k<a[1];k++)
    {
        ...
        brojkombinacije += C(broj - k, 5);

    }   
    console.log(brojkombinacije);
    console.log(C(38,6)+C(37,6)+C(35,5));
var brojmobilnog=1234567;
*/
//------------------------
// var d=38;
// for(i=0;i<7;i++){
//     if(brojmobilnog<=C(d,6-i)) brojmobilnog-=C(d,6-i);
// }